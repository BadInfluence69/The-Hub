...
An open-source, self-hosted video platform powered by Python that allows you to stream YouTube and Tubi TV content completely ad-free across your devices. The Hub acts as a local server, scraping public content and offering a completely independent ecosystem free from trackers, ads, and restrictions. 
...
* **Ad-Free Streaming:** Watch your favorite public YouTube videos, live streams, and Tubi TV content with zero commercial interruptions.
* **Smart Playback Persistence:** Integrated JavaScript support ensures pages do not automatically restart or refresh, preserving your exact video progress and place.
...
* **Streamlined Codebase:** Version 5.3 introduces a cleaner, more structured architectural layout for improved stability and easier code maintenance.
...
* **Hybrid Data Fetching:** Operates seamlessly out of the box using public scraping methods. If you prefer enhanced performance for YouTube content, you can optionally plug in your own YouTube Data API key (not required).

---

### Project Limitations & Workarounds

Because this project bypasses traditional platform tracking, it operates entirely within its own local ecosystem. 

* **No Official Platform Sign-In:** You cannot log into your official YouTube or Tubi accounts. Instead, use the automated local account portal to manage your watch experience.
* **Local Interactions Only:** You cannot leave public comments directly on third-party sites. All comments, likes, and dislikes are stored and interacted with internally via your local database file.
* **No Paid Content:** Rental movies, premium subscription content, and paid features are not supported.
...
* This handles content scraping for YouTube and Tubi TV, endpoint routing, the local account system, and initial database generation.
...
* **FFmpeg Build:** http://72.51.249.70/TheHub/ffmpeg.zip
* **YT-DLP:** Custom modified version compiled directly from source code.
